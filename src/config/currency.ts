/**
 * Selectable currencies, as ISO 4217 codes only.
 *
 * Names, symbols and decimal places all come from `Intl` at runtime (see
 * `utils/money.ts`), so there is no table to maintain and nothing to go stale.
 * Every code here resolves to a name via `Intl.DisplayNames`.
 */
export const CURRENCY_CODES = [
  'AED', 'AFN', 'ALL', 'AMD', 'AOA', 'ARS', 'AUD', 'AWG',
  'AZN', 'BAM', 'BBD', 'BDT', 'BGN', 'BHD', 'BIF', 'BMD',
  'BND', 'BOB', 'BOV', 'BRL', 'BSD', 'BTN', 'BWP', 'BYN',
